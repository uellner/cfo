...
var paths = {
  app:     'cfo/static/',
  dist:    'cfo/static/dist/',
}
paths.markup  = paths.app + 'jade/',
paths.styles  = paths.app + 'less/',
paths.images  = paths.app + 'img/',
paths.scripts = paths.app + 'js/'
...
gulp.task('images', function() {
    log('Copying images to dist folder..');
